...
# rename files ------------------------------------------------------------
input_dir <- c("/media/HDD/Daten/WHK2/Data/netCDF/2ter_lauf/rcp45/",
               "/media/HDD/Daten/WHK2/Data/netCDF/2ter_lauf/rcp85/")
for(DIR in input_dir){
  ...
  lapply(nc.files, FUN = function(ifile) {
...
#input_dir <- c("/media/HDD/Daten/WHK2/Data/netCDF/2ter_lauf")
...
output_path <- "/home/ahmed/Nextcloud/files/KlimaKonform/Plotting/6ter_lauf/boxplots"
